  ...
  <div class="modal-body">
       ...
       <div class="form-group d-flex flex-column align-items-center mb-4">
        ...
        <div class="card-body">
          ...
          <label for="image-token" class="remix-icon ri-upload-cloud-fill color-white upload-inner" title="Upload photo"> <span> <?php echo lang('upload_photo')?></span></label>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="product_name" value="<?php echo $result->name ?>" placeholder="<?php echo lang('Name')?>">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="code" value="<?php echo $result->code ?>" placeholder="<?php echo lang('Code')?>">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="unit_price" value="<?php echo $result->price ?>" placeholder="<?php echo lang('unit_price')?>">
