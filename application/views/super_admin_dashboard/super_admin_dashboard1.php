                        ...
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                <ul class="header-notification-area">
                                    ...
                                    <!--User-->
                                    <?php
                                    $fixed_array=array('id1'=>'dashboard','id2'=>'client','id3'=>'product','id4'=>'invoice','id5'=>'payment','id6'=>'report','id7'=>'user_roles','id8'=>'setting');
...
<nav class="side-header-menu" id="side-header-menu">
                <ul>  
                <?php if (in_array($fixed_array['id1'], $all_feature)) {?>
               ...
               <?php if (in_array($fixed_array['id2'], $all_feature)) {?>
                ...
                <?php  } ?>  
                <?php if (in_array($fixed_array['id3'], $all_feature)) {?>               
                ...
                <?php if (in_array($fixed_array['id4'], $all_feature)) {?>
                ...
                <?php if (in_array($fixed_array['id5'], $all_feature)) {?>
               ...
               <?php if (in_array($fixed_array['id6'], $all_feature)) {?>
               ...
               <?php if (in_array($fixed_array['id7'], $all_feature)) {?>
               ...
               <?php  } ?> 
               <?php if (in_array($fixed_array['id8'], $all_feature)) {?>
 ...
 (function ($) {
    ...
    if( $('#chartjs-market-trends-chart').length ) {
        ...
        var MTCconfig = {
            type: 'doughnut',
            data: {
                labels: ['<?php echo lang('received_amount')?>', '<?php echo lang('due_amount')?>','<?php echo lang('paid_amount')?>','<?php echo lang('pending_amount')?>' ],
                datasets: [{
