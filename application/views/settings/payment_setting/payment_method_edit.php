...
<div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo lang('Cancel');?></button><button type="submit" id="ami" class="btn btn-primary"><?php echo lang('save');?></button></div>
</form>
