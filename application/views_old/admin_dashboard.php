                                  ...
                                  ?>
                                    ...
                                    <li class="adomx-dropdown col-auto">
                                        ...
                                        <div class="adomx-dropdown-menu dropdown-menu-user">
                                            ...
                                            <div class="body">
                                                <ul>
                                                    <li><a href="<?php echo base_url()?>admin_profile"><i class="zmdi zmdi-account"></i><?php echo lang('My Profile')?></a></li>
                                                    <li><a href="#"><i class="far fa-bell"></i><?php echo lang('Notificatons')?></a></li>
                                                    <li><a href="<?php echo base_url();?>setting_index"><i class="zmdi zmdi-settings"></i><?php echo lang('Settings')?></a></li>
        ...
        <div class="side-header show">
            ...
            <div class="side-header-inner custom-scroll">
                ...
                <ul>
                    ...
                    <li class="has-sub-menu" <?php if($this->uri->segment(1)=="Payment summary"|| $this->uri->segment(1)=="client_statement" || $this->uri->segment(1)=="invoice_report"){echo 'id="active"';}?> ><a href="#"><i class="far fa-chart-bar"></i> <span><?php echo lang('Reports')?></span></a>
                            <ul class="side-header-sub-menu">
                                <li><a href="<?php echo base_url()?>Payment summary""><span><?php echo lang('Payment summary"')?></span></a></li>
                                <li><a href="<?php echo base_url()?>client_statement"><span><?php echo lang('Client statement')?></span></a></li>
                                <li><a href="<?php echo base_url()?>invoice_report"><span><?php echo lang('Invoice report')?></span></a></li>
                                
                            </ul>
                    </li>

                    <li <?php if($this->uri->segment(1)=="user_roles_index"){echo 'class="active"';}?> >
                        <a href="<?php echo base_url()?>user_roles_index"><i class="zmdi zmdi-account-box-o"></i> <span><?php echo lang('Users & Roles')?></span></a>
                    </li>
