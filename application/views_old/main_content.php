                                ...
                                <ul class="widget-chat-list">
                                    ...
                                    <li>
                                        <div class="widget-chat">
                                            ...
                                            <div class="body">
                                                <div class="image"><img src="<?php echo base_url();?>front-end/assets/images/comment/comment-1.jpg" alt=""></div>
                                                <div class="content">
                                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="widget-chat">
                                            ...
                                            <div class="body">
                                                <div class="image"><img src="<?php echo base_url();?>front-end/assets/images/comment/comment-2.jpg" alt=""></div>
                                                <div class="content">
                                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the.</p>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="widget-chat">
                                            ...
                                            <div class="body">
                                                <div class="image"><img src="<?php echo base_url();?>front-end/assets/images/comment/comment-3.jpg" alt=""></div>
                                                <div class="content">
                                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                                </div>
                                            </div>
