                                ...
                                <ul class="header-notification-area">
                                  ...
                                  ?>
                                    ...
                                    <li class="adomx-dropdown col-auto">
                                        <a class="toggle" href="#">
                                            <span class="user">
                                            <span class="name"><?php echo $login_info['first_name']?> <?php echo $login_info['last_name']?></span>
                                            </span>
                                            <span class="avatar">
                                            <img src="<?php echo base_url('images/user/'.$login_info['image'])?>" alt="">
                                        ...
                                        <div class="adomx-dropdown-menu dropdown-menu-user">
                                            <div class="head">
                                                <h5 class="name"><a href="#"><?php echo($login_info['first_name']);?></a></h5>
                                                <a class="mail" href="#"><?php echo($login_info['email']);?></a>
                                            </div>
                                            <div class="body">
                                                <ul>
                                                    <li><a href="<?php echo base_url()?>admin_profile"><i class="zmdi zmdi-account"></i>My Profile</a></li>
                                                    <li><a href="#"><i class="far fa-bell"></i>Notificatons</a></li>
                                                    <li><a href="<?php echo base_url()?>admin_logout"><i class="fas fa-sign-out-alt"></i>Logout</a></li>
                                                </ul>
                                            </div>
                                        </div>
        ...
        <div class="side-header show">
            ...
            <div class="side-header-inner custom-scroll">
                ...
                <ul>
                    ...
                    <li <?php if($this->uri->segment(1)==""){echo 'class="active"';}?> ><a href="<?php echo base_url()?>Dashboard"><i class="ti-home"></i> <span>Dashboard</span></a></li>
                    
                 
                 
                    <li <?php if($this->uri->segment(1)=="invoice_index"){echo 'class="active"';}?>><a href="<?php echo base_url()?>invoice_index"><i class="far fa-file-alt"></i> <span>Invoices</span></a></li>
                    

                 
                    <li <?php if($this->uri->segment(1)=="payment_index"){echo 'class="active"';}?>><a href="<?php echo base_url()?>payment_index"><i class="fas fa-dollar-sign"></i></i> <span>Payments</span></a></li> 
                    

                    <li class="has-sub-menu" <?php if($this->uri->segment(1)=="Payment summary""|| $this->uri->segment(1)=="client_statement" || $this->uri->segment(1)=="invoice_report"){echo 'id="active"';}?> ><a href="#"><i class="far fa-chart-bar"></i> <span>Reports</span></a>
                            <ul class="side-header-sub-menu">
                                <li><a href="<?php echo base_url()?>Payment summary""><span>Payment summary</span></a></li>
                                <li><a href="<?php echo base_url()?>client_statement"><span>Client statement</span></a></li>
                                <li><a href="<?php echo base_url()?>invoice_report"><span>Invoice report</span></a></li>
...
============================================ -->
    ...
    <!--Moment-->
    <script src="<?php echo base_url();?>front-end/assets/js/plugins/moment/moment.min.js"></script>

    <!--Daterange Picker-->
    <script src="<?php echo base_url();?>front-end/assets/js/plugins/daterangepicker/daterangepicker.js"></script>
    <script src="<?php echo base_url();?>front-end/assets/js/plugins/daterangepicker/daterangepicker.active.js"></script>
    ...
    <!--VMap-->
    <script src="<?php echo base_url();?>front-end/assets/js/plugins/vmap/jquery.vmap.min.js"></script>
    <script src="<?php echo base_url();?>front-end/assets/js/plugins/vmap/maps/jquery.vmap.world.js"></script>
    <script src="<?php echo base_url();?>front-end/assets/js/plugins/vmap/maps/samples/jquery.vmap.sampledata.js"></script>
    <script src="<?php echo base_url();?>front-end/assets/js/plugins/vmap/vmap.active.js"></script>
