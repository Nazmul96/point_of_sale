      ...
      <div class="box-body">
         ...
         <form action="<?php echo base_url();?>general_update" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row position-relative">
                            ...
                            <small>(Recommended size: 210 x 50 px)</small>
                            </div>
                            <div class="col-md-8" >
                  ...
                  <div class="row position-relative">
                            ...
                            <small>(Recommended size: 50 x 50 px)</small>
                            </div>
                            <div class="col-md-8">
                  ...
                  <div class="row position-relative">
                            ...
                            <small>(Recommended size: 1920 x 1080 px)</small>
                            </div>
                            <div class="col-md-8">
                  ...
                  <br>
                  <p class="text-primary">Date and time setting</p>
                  <div class="row">
                            <div class="col-md-3">
                            <b>Date format</b>
                  ...
                  <br>
                  <br>
                  <p class="text-primary">Currency setting</p>
                  <div class="row">
                            <div class="col-md-3">
                            <b>Currency symbol</b>
