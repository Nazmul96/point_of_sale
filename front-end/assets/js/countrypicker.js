    ...
    for (i = 0; i < countryInput.length; i++) {
        ...
        if (flag) {
            ...
            $.each(countries, function (index, country) {
                var flagIcon = "front-end/assets/images/flags/" + country.code.toLowerCase() + ".png";
                countryList += "<option data-country-code='" + country.code + "' data-tokens='" + country.code + " " + country.name + "' style='display:block;padding:10px 10px 10px 25px; background-position: 4px 7px; background:url(" + flagIcon + ");background-repeat:no-repeat;' value='" + country.name + "'>" + country.name + "</option>";
            });
            ...
            countryInput.eq(i).on('loaded.bs.select', function (e) {
                ...
                var flagIcon = "front-end/assets/images/flags/" + def.toLowerCase() + ".png";
                button.css("background-size", '20px');
                button.css("background-position", '10px 9px');
                button.css("padding", '10px 10px 10px 40px');
                button.css("background-repeat", 'no-repeat');
                button.css("background", "url('" + flagIcon + "'");
                button.show();
            });
            ...
            countryInput.eq(i).on('change', function () {
                ...
                flagIcon = "front-end/assets/images/flags/" + def + ".png";
                button.css("background-size", '20px');
                button.css("background-position", '10px 9px');
                button.css("padding", '10px 10px 10px 40px');
                button.css("background-repeat", 'no-repeat');
