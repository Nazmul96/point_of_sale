...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2021 at 03:36 PM
...
(33, 'abdulallahh', 2147483647, 'abid11111@gmail.com', '01718465014', '25d55ad283aa400af464c76d713c07ad', 'nowakhali', 'Dhaka', 'norway', '260', NULL, '', ''),
(34, 'abdulallahh', 2147483647, 'abid1111111@gmail.com', '01718465014', '25d55ad283aa400af464c76d713c07ad', 'nowakhali', 'Dhaka', 'norway', '260', NULL, '', ''),
(35, 'Michelle Stein Stein in', 2147483647, 'abid54646@gmail.com', '01718465014', '25d55ad283aa400af464c76d713c07ad', 'nowakhali', 'Dhaka', 'norway', '260', NULL, '', ''),
(36, 'Michelle Stein Stein', 2147483647, 'abid234234@gmail.com', '01718465014', '25d55ad283aa400af464c76d713c07ad', 'nowakhali', 'Dhaka', 'norway', '260', NULL, '', ''),
(37, ' Ulric Brady', 2147483647, 'abiddfgdfd@gmail.com', '01718465014', '25d55ad283aa400af464c76d713c07ad', 'nowakhali', 'Dhaka', 'norway', '260', NULL, '', ''),
(38, 'abdulallah', 1234543, 'admin121212@gmail.com', '01718465014', '25d55ad283aa400af464c76d713c07ad', 'nowakhali', 'Dhaka', 'norway', '260', 'Bangladesh', 'dgdf', 'dfgdfg'),
(39, ' Ulric Brady', 1234121, 'abid@gmail.com', '01718465014', '25d55ad283aa400af464c76d713c07ad', 'nowakhali', 'Dhaka', 'norway', '260', 'Bangladesh', 'dhaka.com', 'lhamdulilallah'),
(40, 'Michelle Stein Stein', 1234787, 'abid567575@gmail.com', '01718465014', '25f9e794323b453885f5181f1b624d0b', 'nowakhali', 'Dhaka', 'norway', '260', 'Bangladesh', 'dhaka.com', 'lhamdulilallah');
...
(66, 5, 100, NULL, '2021-11-23', '2021-11-26', 'Partially', '', '[{\"id\":\"0\",\"products_id\":\"7\",\"quantity\":\"3\",\"price\":\"5678\",\"amount\":\"17034\"}]', '17034', '16034', '8034', 'fixed', '1000', '8000'),
(67, 10, 101, NULL, '2021-11-23', '2021-11-25', 'Unpaid', '', '[{\"id\":\"0\",\"products_id\":\"7\",\"quantity\":\"5\",\"price\":\"5678\",\"amount\":\"28390\"}]', '28390', '27390', '7390', 'fixed', '1000', '20000'),
(68, 5, 102, NULL, '2021-11-24', '2021-12-01', 'Unpaid', '', '[{\"id\":\"0\",\"products_id\":\"8\",\"quantity\":\"2\",\"price\":\"267\",\"amount\":\"534\"}]', '534', '534', '534', 'none', NULL, '');
...
(6, 'A new user has been joined in {app_name}', '<p class=\"text_add\"><img src=\"#\" alt=\"logo\" height=\"60px\" style=\"border:1px solid black;\"></p>      \n            <p>Hi {receiver_name}</p>\n\n            <p>It\'s a piece of good news that a new user {name} has been joined in our application invited. Hope you will enjoy his work and collaborations.</p>\n\n            <p>Thanks for being with us.</p>\n\n            <p>Regards,</p>  \n\n            <p>{app_name}</p> ', 'name,action_by,app_name,app_logo,receiver_name,resource_url', 'app_name', 'A new user has been joined in {app_name}'),
(7, 'A new roles has been created in {app_name}', '                                        <p><img src=\"#\" alt=\"logo\" height=\"60px\" style=\"border:1px solid black;\"></p>      \r\n            <p>Hi {receiver_name}</p>\r\n\r\n            <p>It\'s a piece of good news that a new roles named {name} has been created in our application. Please have a look at that.</p>\r\n\r\n            <p><a href=\"{link}\" class=\"btn btn-primary btn-sm\">View Roles</a></p>\r\n            <p>Thanks for being with us.</p>\r\n\r\n            <p>Regards,</p>  \r\n\r\n            <p>{app_name}</p>                                     ', 'name,action_by,app_name,app_logo,receiver_name,resource_url', 'name,action_by', 'A new roles named {name} has been created.'),
(8, 'A roles has been updated in {app_name}', '                              <p><img src=\"#\" alt=\"logo\" height=\"60px\" style=\"border:1px solid black;\"></p>      \r\n            <p>Hi {receiver_name}</p>\r\n\r\n            <p>It\'s a piece of good news that a new roles named {name} has been updated in our application. Please have a look at that.</p>\r\n\r\n            <p><a href=\"{link}\" class=\"btn btn-primary btn-sm\">View Roles</a></p>\r\n            <p>Thanks for being with us.</p><p>{app_name}</p>                  ', 'name,action_by,app_name,app_logo,receiver_name,resource_url', 'name,action_by', 'A roles named {name} has been updated.'),
(9, 'A roles has been deleted in {app_name}', '                    <p class=\"text_add\"><img src=\"#\" alt=\"logo\" height=\"60px\" style=\"border:1px solid black;\"></p>      \r\n            <p>Hi {receiver_name}</p>\r\n\r\n            <p>We are going to inform you that a roles named has been deleted from our application.</p>\r\n\r\n            <p>Thanks for being with us.</p>\r\n\r\n            <p>Regards,</p>  \r\n\r\n            <p>{app_name}</p>                  ', 'name,action_by,app_name,app_logo,receiver_name', 'name,action_by', 'A roles named {name} has been deleted.'),
...
INSERT INTO `notification_content` (`id`, `type`, `content`, `date_time`, `action_by`) VALUES
(1, 'User joined', 'A new user has been joined in billers', '2021-11-21 5:56 am', 0),
(9, 'Roles created', 'A new roles named Super Admin has been created.', '2021-11-21 2:04 pm', 1),
(10, 'Roles updated', 'A roles named Super Admin has been updated.', '2021-11-21 2:04 pm', 1),
(11, 'Roles deleted', 'A roles named Super Admin has been deleted.', '2021-11-21 2:08 pm', 1),
(12, 'Roles created', 'A new roles named Super Admin has been created.', '2021-11-22 5:32 am', 1),
(13, 'Roles updated', 'A roles named Super Admin has been updated.', '2021-11-22 5:45 am', 1),
(14, 'Roles updated', 'A roles named Super Admin has been updated.', '2021-11-22 5:46 am', 1),
(15, 'Roles updated', 'A roles named Super Admin has been updated.', '2021-11-22 5:47 am', 1),
(16, 'Roles deleted', 'A roles named  has been deleted.', '2021-11-22 6:00 am', 1),
(17, 'Roles created', 'A new roles named Admin has been created.', '2021-11-22 6:03 am', 1),
(18, 'Roles updated', 'A roles named Admin has been updated.', '2021-11-22 9:15 am', 1),
(19, 'Roles updated', 'A roles named Admin has been updated.', '2021-11-22 10:28 am', 1),
(20, 'Roles updated', 'A roles named Admin has been updated.', '2021-11-22 10:48 am', 1),
(21, 'Roles updated', 'A roles named Admin has been updated.', '2021-11-22 10:51 am', 1),
(22, 'Roles updated', 'A roles named Moderator has been updated.', '2021-11-22 12:02 pm', 1),
(23, 'Roles updated', 'A roles named Moderator has been updated.', '2021-11-22 12:03 pm', 1),
(24, 'Roles updated', 'A roles named Moderator has been updated.', '2021-11-22 12:05 pm', 1),
(25, 'Roles updated', 'A roles named Moderator has been updated.', '2021-11-22 12:18 pm', 1),
(26, 'Roles updated', 'A roles named Admin has been updated.', '2021-11-22 12:18 pm', 1),
(27, 'Roles updated', 'A roles named Moderator has been updated.', '2021-11-22 1:46 pm', 1),
(28, 'Roles updated', 'A roles named Admin has been updated.', '2021-11-22 1:47 pm', 1),
(29, 'Roles updated', 'A roles named Moderator has been updated.', '2021-11-23 7:11 am', 6),
(30, 'Roles updated', 'A roles named Admin has been updated.', '2021-11-23 7:11 am', 6),
(31, 'Roles created', 'A new roles named Super Admin has been created.', '2021-11-24 9:58 am', 1),
(32, 'Roles deleted', 'A roles named  has been deleted.', '2021-11-24 10:03 am', 1),
(33, 'Roles created', 'A new roles named Admin has been created.', '2021-11-24 10:03 am', 1),
(34, 'Roles deleted', 'A roles named  has been deleted.', '2021-11-24 10:04 am', 1),
(35, 'Roles updated', 'A roles named Moderator has been updated.', '2021-11-24 10:09 am', 1);
...
(20, 11, 'logggo.jpg', 'iphonee', '79117876', '150000', 'hello fnd');
...
CREATE TABLE `roles` (
  ...
  `all_section` varchar(255) DEFAULT NULL,
...
INSERT INTO `roles` (`id`, `roles_name`, `all_section`, `is_default`) VALUES
(4, 'Super Admin', 'dashboard,client,product,invoice,payment,report,user_roles,setting', 1),
(5, 'Client', 'dashboard,invoice,payment,report', 1),
(6, 'Moderator', 'dashboard,client,product', 0),
(13, 'Admin', 'client,product,invoice', 0);
...
(1, 'General', 'company_name', 'Company name', 'biller'),
(2, 'General', 'company_logo', 'Company logo', 'istockphoto-1283536918-612x612.jpg'),
(3, 'General', 'company_icon', 'Company icon', 'tree-736885__340 (1).jpg'),
(4, 'General', 'company_banner', 'Company banner', 'rest300x300.jpg'),
(5, 'General ', 'company_language', 'Company language', 'bangla'),
...
(16, 'Email_setup', 'supported_mail_services', 'supported mail services', 'sendmail'),
...
(22, 'Email_setup', 'mailpath', 'Mailpath', '/mail/sendmail/clients'),
(23, 'Invoice', 'invoice_logo', 'Invoice logo', 'profile_logo_.jpg'),
(24, 'Invoice', 'invoice_starting_number', 'Invoice starting number', '100'),
...
(1, 'Nazmul', 'Hossain', 'nazmul@gmail.com', 'male', '01963555692', 'comilla                                                                                                                                                                                                                                                        ', '1998-01-03', '81dc9bdb52d04dc20036dbd8313ed055', 'VnkgKzqE', '4', 'active', 'img_avatar.png', '2021-11-25 09:40:09', '2021-11-25 09:39:33', '::1'),
(4, 'abid', 'khan', 'abid@gmail.com', 'male', '01762134211', '    chadpur                                                                                      ', '1997-01-03', 'e10adc3949ba59abbe56e057f20f883e', NULL, '5', 'inactive', 'logggo.jpg', '2021-11-23 10:37:50', '2021-11-23 10:38:07', '::1'),
(6, 'Akib ', 'hasan', 'akib@gmail.com', NULL, NULL, NULL, NULL, 'e10adc3949ba59abbe56e057f20f883e', NULL, '6', 'active', 'rex300x300.jpg', '2021-11-23 10:38:32', '2021-11-23 10:38:43', '::1'),
(7, 'Rafi ', 'Saheb', 'rafi@gmail.com', NULL, NULL, NULL, NULL, 'e10adc3949ba59abbe56e057f20f883e', NULL, '13', 'active', 'naz400x400.jpg', '2021-11-23 10:38:53', '2021-11-23 10:39:36', '::1');
